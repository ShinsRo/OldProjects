	...
	<div class="container">
		<div class="row">
			<div class="update_page">
				<div class="form">
					<form id="updateM" action="${pageContext.request.contextPath }/updateMember_admin.do" method="post">
						<input type="text" readonly="readonly" name="id" placeholder="아이디"
							id="id" value="${requestScope.mvo.id }"><br>
						<input id="pass1" name="password" type="password" placeholder="비밀번호"
							value="${requestScope.mvo.password }" maxlength="11" /><br>
						<input id="pass2" type="password" name="pass2"
							placeholder="비밀번호확인" value="${requestScope.mvo.password }"
							maxlength="11"><br> <span id="passCheckView"></span><br>
						<input type="text" name="name" readonly="readonly"
							placeholder="이름" id="name" value="${requestScope.mvo.name }"><br>
						...
						<input id="addr" type="text" name="addr"
							class="postcodify_address" value="${requestScope.mvo.addr }"
							readonly="readonly" placeholder="주소" /><br />
						<input id="addr_detail" type="text" name="addr_detail" class="postcodify_details"
							value="${requestScope.mvo.addr_detail }" placeholder="상세주소" /><br>
						<select id="tel1" name="tel1">
							...
							value="${requestScope.mvo.job }" placeholder="직업" /><br>
