...
위의 메인 화면에서 신규 사원 등록 버튼을 누르면 아래와 같은 모달 창이 띄어집니다.
 <img src="./docs/images/1.6_admin/admin_user_register.JPG">
 ...
 <img src="./docs/images/1.6_admin/admin_user_register_valid.JPG">
 #### 2. <span class="fas fa-landmark"></span>부서 및 직책관리
 <img src="./docs/images/1.6_admin/admin_dept_posi_dropdown.JPG">
 
##### 2.1 부서 추가
  <img src="./docs/images/1.6_admin/admin_add_dept.JPG">
  <br>
  추가할 부서명을 입력 후 추가하면 됩니다.
  <br>단 이미 존재하는 부서명을 추가시 추가되지 않습니다.
##### 2.2 부서 제거
<img src="./docs/images/1.6_admin/admin_del_dept.JPG">
<br>
현재 존재하는 부서 목록들이 보여지고 그 중 삭제 할 부서를 선택하여<br>
제거 버튼을 누르면 삭제됩니다.
##### 2.3 직책 추가
- 부서 추가와 동일한 방식입니다.
<img src="./docs/images/1.6_admin/admin_add_posi.JPG">
##### 2.4 직책 제거
- 부서 제거와 동일한 방식입니다.
<img src="./docs/images/1.6_admin/admin_del_posi.JPG">
#### 3.사원 정보 변경
사원 목록에서 정보를 변경 할 사원을 선택하시면
사원 목록 우측에 인원 상세 정보에 해당 사원의 상세 정보가 보여집니다.
<img src="./docs/images/1.6_admin/admin_member_info.JPG">
여기서 해당 사원의 정보를 변경 버튼을 누르면 아래와 같이 
핸드폰 번호와 부서 직책이 수정이 가능한 상태로 변합니다.
<img src="./docs/images/1.6_admin/admin_member_modify.JPG">
...
<img src="./docs/images/1.6_admin/admin_member_delete.JPG">
