    ...
    def run(self, startDate, endDate, gubun, inputFilePath, outputLocationPath, defaultQueryPackSize):
        ...
        for idx, his in enumerate(historyResults):
            ...
            for mark in range(1, int(totalMarked), 500):
                ...
                processClass = WosProcess(self.SID, self.jsessionid, self.baseUrl, resultQueue)
        ...
        print("조인 다됨")
        # jobResults = [resultQueue.get(timeout=10.0) for _ in processes]
        # print(jobResults, "프로세스 리턴")
        
        # resStr = " ".join(jobResults)
