...
public class BoardPagingBean {
	...
	public BoardPagingBean() {
	}

	public BoardPagingBean(int totalContents) {
		this.totalContents = totalContents;
	}

	public BoardPagingBean(int totalContents, int nowPage) {
		this.totalContents = totalContents;
	...
	public static void main(String args[]) {
		BoardPagingBean p = new BoardPagingBean(47, 10);
		...
		System.out.println("////////////////////////////");
		p = new BoardPagingBean(31, 6);// 게시물수 31 현재 페이지 6
