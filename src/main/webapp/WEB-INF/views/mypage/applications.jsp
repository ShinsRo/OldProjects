             ...
             <div class="panel panel-default">
                     <div class="panel-heading">
                         <h4 class="panel-title">
                             <a data-toggle="collapse" data-parent="#accordion" href="#collapse${avo.id}">
                                 ${avo.id}님의 신청<br>신청물품 :
                                 <c:forEach items="${avo.pList }" var = "pvo">
                                 ${pvo.ptitle }
                                 </c:forEach>
                             </a>
                         </h4>
					...
					${avo.reason }
					<div align="right">
						<button class = 'btn btn-sm btn-info' id =selectApp>채택</button>
					</div>
                         </div>
                     </div>
                 </div>
