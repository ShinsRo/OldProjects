				...
				<div class="form">
					<form action="${pageContext.request.contextPath }/register.do"
						...
						<input id="id" name="id" type="text" required="required"
							placeholder="아이디" /><br> <span id="idCheckView"></span><br>
						<input id="pass1" name="password" type="password"
							required="required" placeholder="비밀번호" /><br> <input
							id="pass2" type="password" required="required" name="pass2"
							placeholder="비밀번호확인"><br> <span id="passCheckView"></span><br>
						<input id="name" name="name" required="required" type="text"
							placeholder="이름" /><br> <input type="text" name="addrcode"
							class="postcodify_postcode5" placeholder="우편번호" /><br> <input
							type="button" id="postcodify_search_button" class="button"
							value="검색"><br /> <input type="text" name="addr"
							class="postcodify_address" readonly="readonly" placeholder="주소" /><br />
						<input id="addr_detail" type="text" required="required"
							name="addr_detail" class="postcodify_details" placeholder="상세주소" /><br>
						<select id="tel1" name="tel1" required="required">
							<option value="010">010</option>
							<option value="011">011</option>
							<option value="070">070</option>
						</select> <input id="tel2" name="tel2" type="tel" required="required"
							placeholder="전화번호" maxlength="4" /> <input id="tel3" name="tel3"
							type="tel" required="required" placeholder="전화번호" maxlength="4" /><br>
