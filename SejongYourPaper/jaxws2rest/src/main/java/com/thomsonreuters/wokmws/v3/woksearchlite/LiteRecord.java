 ...
 *         &lt;element name="doctype" type="{http://woksearchlite.v3.wokmws.thomsonreuters.com}labelValuesPair" maxOccurs="unbounded" minOccurs="0"/>
...
public class LiteRecord {
    ...
    @XmlElement(nillable = true)
    protected List<LabelValuesPair> doctype;
    @XmlElement(nillable = true)
     ...
     * 
     */
    public List<LabelValuesPair> getDoctype() {
        if (doctype == null) {
            doctype = new ArrayList<LabelValuesPair>();
        }
        return this.doctype;
    }
