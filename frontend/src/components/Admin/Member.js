        ...
        return(
            <div className="card shadow mb-4">
                ...
                <div className="card-body">
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">커리어</div>
                        <div className="h5 mb-0 font-weight-bold text-gray-800"> 부서- {currentCarrer&& currentCarrer.dept}</div>
                        <div className="h5 mb-0 font-weight-bold text-gray-800"> 직책- {currentCarrer&& currentCarrer.posi}</div>
