...
<html>
    ...
    <body>
        ...
        <script src="${pageContext.servletContext.contextPath}/frontAssets/js/bootstrap.min.js"></script>
        ...
        <script src="${pageContext.servletContext.contextPath}/frontAssets/js/jquery.app.js"></script>
